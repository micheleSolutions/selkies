...
SETTING_DEFINITIONS_WEBRTC = [
    ...
    {'name': 'turn_host_external', 'type': 'str', 'default': '', 'help': 'External TURN host for browser-facing RTC config (for split internal/external network topologies). If empty, falls back to turn_host'},
    ...
    {'name': 'stun_host_external', 'type': 'str', 'default': '', 'help': 'External STUN host for browser-facing RTC config (for split internal/external network topologies). If empty, falls back to stun_host'},
